    ...
    private function includeAppModule()
    {
        if(!is_object($this->module)){
            ...
            if(file_exists($this->core->setting['DOCUMENT_ROOT'].$this->core->setting['app-dir'].'/app/modules/'.$module.'.php')){
                require_once $this->core->setting['DOCUMENT_ROOT'].$this->core->setting['app-dir'].'/app/modules/'.$module.'.php';
            }else{
                $this->setModule("notfound");
                require_once $this->core->setting['DOCUMENT_ROOT'].$this->core->setting['app-dir'].'/app/modules/notfound.php';
            }
        }
    }
}
