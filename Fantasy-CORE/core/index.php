...
class core
{
	...
	{
		require_once $this->setting['DOCUMENT_ROOT'].$this->setting['app-dir'].$this->setting['app'];//Запускаем приложение
	...
	private function loadModules()
	{
	    ...
	    foreach($this->appRequire["module"] as $moduleRequire){
	        require_once $this->setting["DOCUMENT_ROOT"]."/core/modules/".$moduleRequire.".class.php";
	    ...
	    foreach($this->appRequire["functions"] as $functionRequire){
	        require_once $this->setting["DOCUMENT_ROOT"]."/core/functions/".$functionRequire.".php";
